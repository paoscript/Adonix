...
exports.getApprenticeByNumberIdentification = async (appreinticeNumberIdentification) => {
    
    let rows = await query("select * from apprentices as a where a.app_identification = ?", [appreinticeNumberIdentification]);
...
exports.getApprenticeByNumberIdentification = async (numberIdentification) => {
    let rows = []
